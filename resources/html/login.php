<title>Inicia sesión</title>
   ...
   <body>
	...
	<div class="container-fluid">	
		<div id="upper-div" style="height: 74vh; width: 100vw; background-color: <?php echo $_SESSION['fnbt']['config']["bgcolor"] ?>;">
	    ...
	    <footer style="height: 24vh; width: 100vw; background-color: <?php echo $_SESSION['fnbt']['config']["bgcolor"] ?>;">
