...
<?php if($_SESSION['fnbt']['id'] == "PF-B1-LTM-0001"){ ?>
		...
		<div class="container-fluid" style="height: 100%; width: 100%; background-color: <?php echo $_SESSION['fnbt']['config']["bgcolor"] ?>;">
	    ...
	    <footer style="height: 25%; padding-top: 17.5vh;" style="background-color: <?php echo $_SESSION['fnbt']['config']["bgcolor"] ?>;">
	    </footer>
